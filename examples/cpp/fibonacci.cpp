...
QBDI::VMAction countIteration(QBDI::VM* vm, QBDI::GPRState *gprState, QBDI::FPRState *fprState, void *data) {
    (*((unsigned*) data))++;
...
int main(int argc, char** argv) {
    ...
    std::cout << "fibonnaci(" << n << ") returns " << retvalue
              << " after " << iterationCount <<" recursions" << std::endl;
