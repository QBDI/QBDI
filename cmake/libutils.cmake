...
MACRO(MERGE_STATIC_LIBS TARGET OUTPUT_NAME LIBS_TO_MERGE)
  ...
  ADD_CUSTOM_COMMAND( 
    OUTPUT  ${SOURCE_FILE}
    COMMAND ${CMAKE_COMMAND} -E copy ${MYSQL_CMAKE_SCRIPT_DIR}/dummy.c ${SOURCE_FILE}
    DEPENDS ${STATIC_LIBS})
  ...
  ELSE()
    ...
    ELSE()
      ...
      CONFIGURE_FILE(
        ...
        ${CMAKE_CURRENT_BINARY_DIR}/merge_archives_${TARGET}.cmake_at_configured
        @ONLY
      )
      FILE(GENERATE
        OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/merge_archives_${TARGET}.cmake
        INPUT ${CMAKE_CURRENT_BINARY_DIR}/merge_archives_${TARGET}.cmake_at_configured
      )
      ADD_CUSTOM_COMMAND(TARGET ${TARGET} POST_BUILD
        COMMAND rm ${TARGET_LOCATION}
        COMMAND ${CMAKE_COMMAND} -P ${CMAKE_CURRENT_BINARY_DIR}/merge_archives_${TARGET}.cmake
        ${STATIC_LIBS}
      )
    ENDIF()
  ENDIF()
