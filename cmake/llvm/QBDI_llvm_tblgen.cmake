...
set(NATIVE_ADDITIONNAL_PARAMETERS)

if(QBDI_INCLUDE_LLVM_CMAKE_MODUKE)
  list(APPEND NATIVE_ADDITIONNAL_PARAMETERS
       "-DCMAKE_MODULE_PATH=${llvm_cmake_SOURCE_DIR}/Modules")
endif()
