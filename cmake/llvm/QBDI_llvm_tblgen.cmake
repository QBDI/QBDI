...
ExternalProject_Add(
  ...
  SOURCE_DIR "${FETCHCONTENT_BASE_DIR}/llvm_tblgen_source_dir"
  BINARY_DIR "${NATIVE_BUILD_DIR}"
  CONFIGURE_COMMAND
    "${CMAKE_COMMAND}" -G "${CMAKE_GENERATOR}" -S <SOURCE_DIR>/llvm -B
    <BINARY_DIR> "-DCMAKE_MAKE_PROGRAM='${CMAKE_MAKE_PROGRAM}'"
