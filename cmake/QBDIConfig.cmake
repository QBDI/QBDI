...
if (QBDI_VERSION_DEV)
    ...
    if (EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.git" AND IS_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}/.git")
        set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${CMAKE_CURRENT_SOURCE_DIR}/.git")
...
if(QBDI_PLATFORM_ANDROID AND NOT (QBDI_ARCH_ARM OR QBDI_ARCH_X86 OR QBDI_ARCH_X86_64))
    message(FATAL_ERROR "Android platform is only supported for X86, X86_64 and ARM architecture.")
endif()
