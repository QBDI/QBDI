...
# ubuntu x64 => qbdi:x64_ubuntu_20.04
"${BASEDIR}/ubuntu_debian/build.sh" "X64" "ubuntu:20.04"
...
push_images "qbdi:x64_ubuntu_20.04" \
    "x64_ubuntu_lts" \
    "x64_ubuntu_20.04" \
    "x64_ubuntu" \
    "x64"
...
docker tag "qbdi:x64_ubuntu_21.10" "${DOCKERHUB_REPO}:latest"
