...
constexpr unsigned READ_16[] = {
    ...
    llvm::X86::MOVRS16rm,
    llvm::X86::MOVRS16rm_EVEX,
    llvm::X86::MOVSW,
    llvm::X86::MOVSX16rm16,
    llvm::X86::MOVSX32rm16,
    llvm::X86::MOVSX64rm16,
    llvm::X86::MOVZX16rm16,
    ...
    llvm::X86::VMAXSHZrm,
    llvm::X86::VMINCSHZrm,
    llvm::X86::VMINMAXSHrmi,
    llvm::X86::VMINMAXSHrmi_Int,
    llvm::X86::VMINMAXSHrmik_Int,
    llvm::X86::VMINMAXSHrmikz_Int,
    llvm::X86::VMINSHZrm,
    llvm::X86::VMULSHZrm,
...
constexpr unsigned READ_32[] = {
    ...
    llvm::X86::MOVRS32rm,
    llvm::X86::MOVRS32rm_EVEX,
    llvm::X86::MOVSL,
    llvm::X86::MOVSSrm,
    llvm::X86::MOVSSrm_alt,
    llvm::X86::MOVSX16rm32,
    llvm::X86::MOVSX32rm32,
    ...
    llvm::X86::VCVTTSS2SI64Srm,
    llvm::X86::VCVTTSS2SI64Srm_Int,
    llvm::X86::VCVTTSS2SI64rm,
    llvm::X86::VCVTTSS2SI64rm_Int,
    llvm::X86::VCVTTSS2SISrm,
    llvm::X86::VCVTTSS2SISrm_Int,
    llvm::X86::VCVTTSS2SIrm,
    llvm::X86::VCVTTSS2SIrm_Int,
    llvm::X86::VCVTTSS2USI64Srm,
    llvm::X86::VCVTTSS2USI64Srm_Int,
    llvm::X86::VCVTTSS2USISrm,
    llvm::X86::VCVTTSS2USISrm_Int,
    ...
    llvm::X86::VMINCSSZrm,
    llvm::X86::VMINMAXSSrmi,
    llvm::X86::VMINMAXSSrmi_Int,
    llvm::X86::VMINMAXSSrmik_Int,
    llvm::X86::VMINMAXSSrmikz_Int,
    llvm::X86::VMINSSZrm,
    llvm::X86::VMINSSrm,
...
constexpr unsigned READ_64[] = {
    ...
    llvm::X86::VCVTTSD2SI64Srm,
    llvm::X86::VCVTTSD2SI64Srm_Int,
    llvm::X86::VCVTTSD2SI64rm,
    llvm::X86::VCVTTSD2SI64rm_Int,
    llvm::X86::VCVTTSD2SISrm,
    llvm::X86::VCVTTSD2SISrm_Int,
    llvm::X86::VCVTTSD2SIrm,
    llvm::X86::VCVTTSD2SIrm_Int,
    llvm::X86::VCVTTSD2USI64Srm,
    llvm::X86::VCVTTSD2USI64Srm_Int,
    llvm::X86::VCVTTSD2USISrm,
    llvm::X86::VCVTTSD2USISrm_Int,
    ...
    llvm::X86::VMAXCSDZrm,
    llvm::X86::VMAXSDZrm,
    llvm::X86::VMAXSDZrm_Int,
    llvm::X86::VMAXSDrm,
    llvm::X86::VMAXSDrm_Int,
    llvm::X86::VMINCSDZrm,
    llvm::X86::VMINMAXSDrmi,
    llvm::X86::VMINMAXSDrmi_Int,
    llvm::X86::VMINMAXSDrmik_Int,
    llvm::X86::VMINMAXSDrmikz_Int,
    llvm::X86::VMINSDZrm,
    llvm::X86::VMINSDZrm_Int,
    llvm::X86::VMINSDrm,
    llvm::X86::VMINSDrm_Int,
    llvm::X86::VMOV64toPQIrm,
    llvm::X86::VMOVDDUPrm,
    llvm::X86::VMOVHPDrm,
    llvm::X86::VMOVHPSrm,
    llvm::X86::VMOVLPDrm,
    ...
    llvm::X86::VSQRTSDZm,
    llvm::X86::VSQRTSDZm_Int,
    llvm::X86::VSQRTSDm,
    llvm::X86::VSQRTSDm_Int,
    llvm::X86::VSUBSDZrm,
    llvm::X86::VSUBSDZrm_Int,
    llvm::X86::VSUBSDrm,
...
constexpr unsigned READ_128[] = {
    ...
    llvm::X86::VHSUBPDrm,
    llvm::X86::VHSUBPSrm,
    llvm::X86::VINSERTF128rmi,
    llvm::X86::VINSERTI128rmi,
    llvm::X86::VLDDQUrm,
...
constexpr unsigned READ_256[] = {
    ...
    llvm::X86::VPERM2F128rmi,
    llvm::X86::VPERM2I128rmi,
    llvm::X86::VPERMDYrm,
...
constexpr unsigned WRITE_128[] = {
    ...
    llvm::X86::VEXTRACTF128mri,
    llvm::X86::VEXTRACTI128mri,
    llvm::X86::VMASKMOVDQU,
    llvm::X86::VMASKMOVDQU64,
    llvm::X86::VMASKMOVPDmr,
    llvm::X86::VMASKMOVPSmr,
