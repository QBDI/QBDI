...
static QBDI::VMAction verifyMemoryAccess(QBDI::VMInstanceRef vm,
  ...
  if (doRead and !mayRead) {
    ...
    const std::set<std::string> noReadInsts{
        ...
        "FXSAVE",     "FXSAVE64",   "INT",          "INT3",       "LFENCE",
        "MFENCE",     "MMX_EMMS",   "MMX_MOVNTQmr", "MOVDIRI32",  "MOVDIRI64",
        "MWAITXrrr",  "MWAITrr",    "PAUSE",        "PREFETCH",   "PREFETCHNTA",
        "PREFETCHT0", "PREFETCHT1", "PREFETCHT2",   "PREFETCHW",  "PREFETCHWT1",
        "PTWRITE64r", "PTWRITEr",   "RDFSBASE",     "RDFSBASE64", "RDGSBASE",
        "RDGSBASE64", "RDPID32",    "SFENCE",       "TRAP",       "UD2B",
        "UMONITOR16", "UMONITOR32", "UMONITOR64",   "VZEROALL",   "VZEROUPPER",
        "WRFSBASE",   "WRFSBASE64", "WRGSBASE",     "WRGSBASE64", "XSETBV",
    };
  ...
  if (doWrite and !mayWrite) {
    ...
    const std::set<std::string> noWriteInsts{
        "CLDEMOTE",   "CLFLUSH",     "CLFLUSHOPT", "CLWB",       "FEMMS",
        "FXRSTOR",    "FXRSTOR64",   "INT",        "INT3",       "LFENCE",
        "MFENCE",     "MMX_EMMS",    "MWAITXrrr",  "MWAITrr",    "PAUSE",
        "PREFETCH",   "PREFETCHNTA", "PREFETCHT0", "PREFETCHT1", "PREFETCHT2",
        "PREFETCHW",  "PREFETCHWT1", "PTWRITE64m", "PTWRITE64r", "PTWRITEm",
        "PTWRITEr",   "RDFSBASE",    "RDFSBASE64", "RDGSBASE",   "RDGSBASE64",
        "RDPID32",    "SFENCE",      "UMONITOR16", "UMONITOR32", "UMONITOR64",
        "VZEROALL",   "VZEROUPPER",  "WRFSBASE",   "WRFSBASE64", "WRGSBASE",
        "WRGSBASE64", "XRSTOR",      "XRSTOR64",   "XRSTORS",    "XRSTORS64",
        "XSETBV",
    };
