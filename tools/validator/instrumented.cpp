...
static QBDI::VMAction verifyMemoryAccess(QBDI::VMInstanceRef vm, QBDI::GPRState *gprState, QBDI::FPRState *fprState, void *data) {
    ...
    if (doRead and !mayRead) {
        ...
        const std::set<std::string> shouldReadInsts {
            ...
            "FBLDm", "FCOM32m", "FCOM64m", "FCOMP32m",
            "FCOMP64m", "FICOM16m", "FICOM32m", "FICOMP16m",
            "FICOMP32m", "FLDENVm", "FRSTORm",
            "LODSB", "LODSL", "LODSQ", "LODSW",
            "LRETIL", "LRETIQ", "LRETIW", "LRETL", "LRETQ",
            "LRETW", "MOVDIR64B16",
            "MOVSB", "MOVSL", "MOVSQ", "MOVSW",
            "OR32mi8Locked", "RCL16m1" "RCL16mCL", "RCL16mi",
            "RCL32m1", "RCL32mCL", "RCL32mi", "RCL64m1",
            "RCL64mCL", "RCL64mi", "RCL8m1", "RCL8mCL",
            "RCL8mi", "RCR16m1", "RCR16mCL", "RCR16mi",
            "RCR32m1", "RCR32mCL", "RCR32mi", "RCR64m1",
            "RCR64mCL", "RCR64mi", "RCR8m1", "RCR8mCL",
            "RCR8mi", "RETIL", "RETIQ", "RETIW",
            "RETL", "RETQ", "RETW",
        ...
        const std::set<std::string> noReadInsts {
            ...
            "INT3", "LFENCE", "MFENCE", "MMX_EMMS",
            "MMX_MOVNTQmr", "MOVDIRI32", "MOVDIRI64", "MWAITXrrr",
    ...
    if (doWrite and !mayWrite) {
        ...
        const std::set<std::string> shouldWriteInsts {
            ...
            "FBSTPm", "FNSTSWm", "FSAVEm", "FSTENVm", "MOVDIR64B16",
            "MOVSB", "MOVSL", "MOVSQ", "MOVSW", "OR32mi8Locked",
        ...
        const std::set<std::string> noWriteInsts {
            ...
            "PTWRITEm", "PTWRITEr", "RDFSBASE", "RDFSBASE64",
            "RDGSBASE", "RDGSBASE64", "RDPID32", "SFENCE",
            "UMONITOR16", "UMONITOR32", "UMONITOR64", "VZEROALL",
            "VZEROUPPER", "WRFSBASE", "WRFSBASE64", "WRGSBASE",
            "WRGSBASE64", "XRSTOR", "XRSTOR64", "XRSTORS",
            "XRSTORS64", "XSETBV",
        };
