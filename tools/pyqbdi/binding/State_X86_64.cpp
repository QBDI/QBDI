...
void init_binding_State(py::module_& m) {
    ...
    py::class_<FPRState>(m, "FPRState")
        ...
        .def_property("xmm8",
                ...
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.xmm8, sizeof(t.xmm8),0);},
                "XMM 8")
        .def_property("xmm9",
                [](const FPRState &t) {return py::bytes(t.xmm9, sizeof(t.xmm9));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.xmm9, sizeof(t.xmm9),0);},
                "XMM 9")
        .def_property("xmm10",
                [](const FPRState &t) {return py::bytes(t.xmm10, sizeof(t.xmm10));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.xmm10, sizeof(t.xmm10),0);},
                "XMM 10")
        .def_property("xmm11",
                [](const FPRState &t) {return py::bytes(t.xmm11, sizeof(t.xmm11));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.xmm11, sizeof(t.xmm11),0);},
                "XMM 11")
        .def_property("xmm12",
                [](const FPRState &t) {return py::bytes(t.xmm12, sizeof(t.xmm12));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.xmm12, sizeof(t.xmm12),0);},
                "XMM 12")
        .def_property("xmm13",
                [](const FPRState &t) {return py::bytes(t.xmm13, sizeof(t.xmm13));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.xmm13, sizeof(t.xmm13),0);},
                "XMM 13")
        .def_property("xmm14",
                [](const FPRState &t) {return py::bytes(t.xmm14, sizeof(t.xmm14));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.xmm14, sizeof(t.xmm14),0);},
                "XMM 14")
        .def_property("xmm15",
                [](const FPRState &t) {return py::bytes(t.xmm15, sizeof(t.xmm15));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.xmm15, sizeof(t.xmm15),0);},
                "XMM 15")
        .def_property("ymm0",
        ...
        .def_property("ymm8",
                ...
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.ymm8, sizeof(t.ymm8),0);},
                "YMM8[255:128]")
        .def_property("ymm9",
                [](const FPRState &t) {return py::bytes(t.ymm9, sizeof(t.ymm9));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.ymm9, sizeof(t.ymm9),0);},
                "YMM9[255:128]")
        .def_property("ymm10",
                [](const FPRState &t) {return py::bytes(t.ymm10, sizeof(t.ymm10));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.ymm10, sizeof(t.ymm10),0);},
                "YMM10[255:128]")
        .def_property("ymm11",
                [](const FPRState &t) {return py::bytes(t.ymm11, sizeof(t.ymm11));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.ymm11, sizeof(t.ymm11),0);},
                "YMM11[255:128]")
        .def_property("ymm12",
                [](const FPRState &t) {return py::bytes(t.ymm12, sizeof(t.ymm12));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.ymm12, sizeof(t.ymm12),0);},
                "YMM12[255:128]")
        .def_property("ymm13",
                [](const FPRState &t) {return py::bytes(t.ymm13, sizeof(t.ymm13));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.ymm13, sizeof(t.ymm13),0);},
                "YMM13[255:128]")
        .def_property("ymm14",
                [](const FPRState &t) {return py::bytes(t.ymm14, sizeof(t.ymm14));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.ymm14, sizeof(t.ymm14),0);},
                "YMM14[255:128]")
        .def_property("ymm15",
                [](const FPRState &t) {return py::bytes(t.ymm15, sizeof(t.ymm15));},
                [](FPRState &t, py::bytes v) {std::string(v).copy(t.ymm15, sizeof(t.ymm15),0);},
                "YMM15[255:128]")
    ...
    py::class_<GPRState>(m, "GPRState")
        ...
        .def_property_readonly("REG_LR",
                [](const GPRState& obj) {return py::none();}, "not available on X86_64")
