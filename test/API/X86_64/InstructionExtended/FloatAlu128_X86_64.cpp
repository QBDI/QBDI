...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ADDPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "addpd 0x20(%rbx,%rsi,4), %xmm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ADDPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "addps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ADDSUBPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "addsubpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ADDSUBPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "addsubps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ANDNPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "andnpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ANDNPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "andnps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ANDPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "andpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ANDPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "andps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-DIVPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "divpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-DIVPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "divps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-HADDPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "haddpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-HADDPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "haddps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-HSUBPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "hsubpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-HSUBPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "hsubps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MAXPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "maxpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MAXPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "maxps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MINPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "minpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MINPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "minps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MULPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "mulpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MULPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "mulps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ORPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "orpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ORPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "orps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-SUBPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "subpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-SUBPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "subps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-XORPDrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "xorpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-XORPSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "xorps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-RCPPSm") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "rcpps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-RSQRTPSm") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "rsqrtps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-SQRTPDm") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "sqrtpd 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-SQRTPSm") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "sqrtps 0x20(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VADDPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vaddpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VADDPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vaddps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VADDSUBPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vaddsubpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VADDSUBPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vaddsubps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VANDNPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vandnpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VANDNPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vandnps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VANDPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vandpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VANDPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vandps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VDIVPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vdivpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VDIVPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vdivps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VHADDPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vhaddpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VHADDPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vhaddps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VHSUBPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vhsubpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VHSUBPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vhsubps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VMAXPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmaxpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VMAXPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmaxps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VMINPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vminpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VMINPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vminps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VMULPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmulpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VMULPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmulps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VORPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vorpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VORPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vorps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VSUBPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vsubpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VSUBPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vsubps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VXORPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vxorpd 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VXORPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vxorps 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VRCPPSm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vrcpps 0x11(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VRSQRTPSm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vrsqrtps 0x11(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VSQRTPDm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vsqrtpd 0x11(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VSQRTPSm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vsqrtps 0x11(%rbx,%rsi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
