...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPBSSDSYrm") {
  ...
  const char source[] = "vpdpbssds 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPBSSDYrm") {
  if (!checkFeature("avxvnniint8")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vpdpbssd 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPBSUDSYrm") {
  if (!checkFeature("avxvnniint8")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vpdpbsuds 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPBSUDYrm") {
  if (!checkFeature("avxvnniint8")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vpdpbsud 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPBUSDSYrm") {
  ...
  const char source[] = "{vex} vpdpbusds 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPBUSDYrm") {
  if (!checkFeature("avxvnni")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "{vex} vpdpbusd 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPBUUDSYrm") {
  if (!checkFeature("avxvnniint8")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vpdpbuuds 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPBUUDYrm") {
  if (!checkFeature("avxvnniint8")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vpdpbuud 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPWSSDSYrm") {
  if (!checkFeature("avxvnni")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "{vex} vpdpwssds 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPWSSDYrm") {
  if (!checkFeature("avxvnni")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "{vex} vpdpwssd 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPWSUDSYrm") {
  ...
  const char source[] = "vpdpwsuds 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPWSUDYrm") {
  if (!checkFeature("avxvnniint16")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vpdpwsud 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPWUSDSYrm") {
  if (!checkFeature("avxvnniint16")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vpdpwusds 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPWUSDYrm") {
  if (!checkFeature("avxvnniint16")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vpdpwusd 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPWUUDSYrm") {
  if (!checkFeature("avxvnniint16")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vpdpwuuds 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPDPWUUDYrm") {
  if (!checkFeature("avxvnniint16")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vpdpwuud 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPMADD52HUQYrm") {
  ...
  const char source[] = "{vex} vpmadd52huq 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPMADD52LUQYrm") {
  if (!checkFeature("avxifma")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "{vex} vpmadd52luq 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
