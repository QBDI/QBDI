...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VBLENDPDYrmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vblendpd $0x1, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VBLENDPSYrmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vblendps $0x1, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VBLENDVPDYrmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vblendvpd %ymm2, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VBLENDVPSYrmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vblendvps %ymm2, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VMPSADBWYrmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vmpsadbw $0x1, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPALIGNRYrmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpalignr $0x1, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPBLENDDYrmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpblendd $0x1, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPBLENDVBYrmr") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpblendvb %ymm2, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPBLENDWYrmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpblendw $0x1, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERM2F128rmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vperm2f128 $0x1, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERM2I128rmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vperm2i128 $0x1, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMDYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpermd 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMIL2PDYmr") {
  if (!checkFeature("xop")) {
    return;
  }
  const char source[] =
      "vpermil2pd $0x1, %ymm2, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMIL2PDYrm") {
  if (!checkFeature("xop")) {
    return;
  }
  const char source[] =
      "vpermil2pd $0x1, 0x11(%rbx,%rsi,4), %ymm2, %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMIL2PSYmr") {
  if (!checkFeature("xop")) {
    return;
  }
  const char source[] =
      "vpermil2ps $0x1, %ymm2, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMIL2PSYrm") {
  if (!checkFeature("xop")) {
    return;
  }
  const char source[] =
      "vpermil2ps $0x1, 0x11(%rbx,%rsi,4), %ymm2, %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMILPDYmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpermilpd $0x1, 0x11(%rbx,%rsi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMILPDYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpermilpd 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMILPSYmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpermilps $0x1, 0x11(%rbx,%rsi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMILPSYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpermilps 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMPDYmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpermpd $0x1, 0x11(%rbx,%rsi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMPSYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpermps 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPERMQYmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpermq $0x1, 0x11(%rbx,%rsi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPSHUFBYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpshufb 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPSHUFDYmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpshufd $0x1, 0x11(%rbx,%rsi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPSHUFHWYmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpshufhw $0x1, 0x11(%rbx,%rsi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPSHUFLWYmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpshuflw $0x1, 0x11(%rbx,%rsi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPUNPCKHBWYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpunpckhbw 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPUNPCKHDQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpunpckhdq 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPUNPCKHQDQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpunpckhqdq 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPUNPCKHWDYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpunpckhwd 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPUNPCKLBWYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpunpcklbw 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPUNPCKLDQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpunpckldq 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPUNPCKLQDQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpunpcklqdq 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VPUNPCKLWDYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpunpcklwd 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VSHUFPDYrmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vshufpd $0x1, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VSHUFPSYrmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vshufps $0x1, 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VUNPCKHPDYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vunpckhpd 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VUNPCKHPSYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vunpckhps 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VUNPCKLPDYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vunpcklpd 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VUNPCKLPSYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vunpcklps 0x11(%rbx,%rsi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
