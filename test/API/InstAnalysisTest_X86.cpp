...
TEST_CASE_METHOD(InstAnalysisTest, "InstAnalysisTest_X86-lea") {
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_NONE, 0, 4, "EBX", 0, 1, QBDI::REGISTER_WRITE},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_ADDR, 0, 4, "EAX", 0, 0, QBDI::REGISTER_READ},
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 1, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_INVALID, QBDI::OPERANDFLAG_ADDR, 0, 0, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 0, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_INVALID, QBDI::OPERANDFLAG_ADDR, 0, 0, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
...
TEST_CASE_METHOD(InstAnalysisTest, "InstAnalysisTest_X86-lea-same-reg") {
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_NONE, 0, 4, "EAX", 0, 0, QBDI::REGISTER_WRITE},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_ADDR, 0, 4, "EAX", 0, 0, QBDI::REGISTER_READ},
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 1, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_ADDR, 0, 4, "EAX", 0, 0, QBDI::REGISTER_READ},
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 0, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_NONE, 0, 4, "EBX", 0, 1, QBDI::REGISTER_WRITE},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_ADDR, 0, 4, "EAX", 0, 0, QBDI::REGISTER_READ},
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 4, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_ADDR, 0, 4, "EDX", 0, 3, QBDI::REGISTER_READ},
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 0x45, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_INVALID, QBDI::OPERANDFLAG_ADDR, 0, 0, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
        }, QBDI::REGISTER_UNUSED);
}
...
TEST_CASE_METHOD(InstAnalysisTest, "InstAnalysisTest_X86-addmi") {
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_ADDR, 0, 4, "ECX", 0, 2, QBDI::REGISTER_READ},
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 1, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_INVALID, QBDI::OPERANDFLAG_ADDR, 0, 0, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 0, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_INVALID, QBDI::OPERANDFLAG_ADDR, 0, 0, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
...
TEST_CASE_METHOD(InstAnalysisTest, "InstAnalysisTest_X86-movrr") {
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_NONE, 0, 4, "EBX", 0, 1, QBDI::REGISTER_WRITE},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_NONE, 0, 4, "ECX", 0, 2, QBDI::REGISTER_READ},
        }, QBDI::REGISTER_UNUSED);
}
...
TEST_CASE_METHOD(InstAnalysisTest, "InstAnalysisTest_X86-xchgrr") {
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_NONE, 0, 4, "EBX", 0, 1, QBDI::REGISTER_WRITE},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_NONE, 0, 4, "ECX", 0, 2, QBDI::REGISTER_WRITE},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_NONE, 0, 4, "EBX", 0, 1, QBDI::REGISTER_READ},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_NONE, 0, 4, "ECX", 0, 2, QBDI::REGISTER_READ},
        }, QBDI::REGISTER_UNUSED);
}
...
TEST_CASE_METHOD(InstAnalysisTest, "InstAnalysisTest_X86-movsb") {
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_ADDR, 0, 4, "EDI", 0, 5, QBDI::REGISTER_READ},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_ADDR, 0, 4, "ESI", 0, 4, QBDI::REGISTER_READ},
            {QBDI::OPERAND_INVALID, QBDI::OPERANDFLAG_ADDR, 0, 0, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
...
TEST_CASE_METHOD(InstAnalysisTest, "InstAnalysisTest_X86-ret") {
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_IMPLICIT, 0, 4, "ESP", 0, 7, QBDI::REGISTER_READ_WRITE},
        }, QBDI::REGISTER_UNUSED);
}
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            ...
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_IMPLICIT, 0, 4, "ESP", 0, 7, QBDI::REGISTER_READ_WRITE},
            {QBDI::OPERAND_SEG, QBDI::OPERANDFLAG_IMPLICIT, 0, 4, "SSP", 0, -1, QBDI::REGISTER_READ},
        }, QBDI::REGISTER_UNUSED);
}
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            ...
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 1, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_INVALID, QBDI::OPERANDFLAG_ADDR, 0, 0, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 0xa, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_INVALID, QBDI::OPERANDFLAG_ADDR, 0, 0, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_GPR, QBDI::OPERANDFLAG_IMPLICIT, 0, 4, "ESP", 0, 7, QBDI::REGISTER_READ_WRITE},
            {QBDI::OPERAND_SEG, QBDI::OPERANDFLAG_IMPLICIT, 0, 4, "SSP", 0, -1, QBDI::REGISTER_READ},
        }, QBDI::REGISTER_UNUSED);
    ...
    checkOperand(vm.getCachedInstAnalysis(addr, QBDI::ANALYSIS_OPERANDS),
        {
            ...
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 1, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_INVALID, QBDI::OPERANDFLAG_ADDR, 0, 0, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_ADDR, 0x0, 4, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
            {QBDI::OPERAND_INVALID, QBDI::OPERANDFLAG_ADDR, 0, 0, nullptr, 0, -1, QBDI::REGISTER_UNUSED},
