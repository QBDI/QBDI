...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CMPSB") {
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-LODSB") {
  ...
  CHECK(ran);
  CHECK(seen);
  CHECK((state->eax & 0xff) == 0x11);
  CHECK(state->esi == (QBDI::rword)&buf[1]);
}

TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-STOSB") {
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-XLAT") {
