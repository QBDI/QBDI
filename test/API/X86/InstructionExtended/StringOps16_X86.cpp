...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CMPSW") {
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-LODSW") {
  ...
  CHECK(ran);
  CHECK(seen);
  CHECK((state->eax & 0xffff) == 0x1122);
  CHECK(state->esi == (QBDI::rword)&buf[1]);
}

TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MOVSW") {
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SCASW") {
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-STOSW") {
