...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_ARM-ldab") {
  ...
  vm.addMnemonicCB("LDAB", QBDI::PREINST, checkAccess, &expectedPre);
  vm.addMnemonicCB("LDAB", QBDI::POSTINST, checkAccess, &expectedPost);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_ARM-stlb") {
  if (!checkFeature("acquire-release")) {
    return;
  }
  ...
  vm.addMnemonicCB("STLB", QBDI::PREINST, checkAccess, &expectedPre);
  vm.addMnemonicCB("STLB", QBDI::POSTINST, checkAccess, &expectedPost);
