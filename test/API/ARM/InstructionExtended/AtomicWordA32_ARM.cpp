...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_ARM-lda") {
  ...
  vm.addMnemonicCB("LDA", QBDI::PREINST, checkAccess, &expectedPre);
  vm.addMnemonicCB("LDA", QBDI::POSTINST, checkAccess, &expectedPost);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_ARM-stl") {
  if (!checkFeature("acquire-release")) {
    return;
  }
  ...
  vm.addMnemonicCB("STL", QBDI::PREINST, checkAccess, &expectedPre);
  vm.addMnemonicCB("STL", QBDI::POSTINST, checkAccess, &expectedPost);
