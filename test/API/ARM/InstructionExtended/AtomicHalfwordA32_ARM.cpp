...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_ARM-ldah") {
  ...
  vm.addMnemonicCB("LDAH", QBDI::PREINST, checkAccess, &expectedPre);
  vm.addMnemonicCB("LDAH", QBDI::POSTINST, checkAccess, &expectedPost);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_ARM-stlh") {
  if (!checkFeature("acquire-release")) {
    return;
  }
  ...
  vm.addMnemonicCB("STLH", QBDI::PREINST, checkAccess, &expectedPre);
  vm.addMnemonicCB("STLH", QBDI::POSTINST, checkAccess, &expectedPost);
